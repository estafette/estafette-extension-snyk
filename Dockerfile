...
RUN curl -fSL https://repo.maven.apache.org/maven2/org/apache/maven/wagon/wagon-http/2.8/wagon-http-2.8-shaded.jar --output /usr/share/java/wagon-http-shaded-2.8.jar \
